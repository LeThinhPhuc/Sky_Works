      ...
      {jobsData ? (
        <main className="dark:bg-slate-800 dark:text-white dark:border-white  flex-1 flex justify-center flex-col w-full items-center relative">
          ...
          >
            ...
            <div className="dark:bg-slate-800 dark:text-white dark:border-white  text-3xl xl:text-4xl xl:leading-normal font-bold mb-5 mt-5 max-w-[75%] md:max-w-[60%] lg:max-w-[50%] xl:max-w-[40%] 2xl:max-w-[35%]">
              {joblist2?.title}
            </div>
            {joblist2?.location}
          </header>
          <div className="dark:bg-slate-800 dark:text-white dark:border-white  flex flex-col text-left  max-w-[856px] p-5 xl:p-0">
            ...
            {/* Benefits */}
            <div>
              <h1 className="dark:bg-slate-800 dark:text-white dark:border-white  text-2xl font-medium mt-3 mb-2">
                Benefits
              </h1>
              <p className="dark:bg-slate-800 dark:text-white dark:border-white  flex gap-x-2 my-5">
                <img
                  title=""
                  alt=""
              ...
              <p className="dark:bg-slate-800 dark:text-white dark:border-white  flex gap-x-2 mt-5">
                <img
                  title=""
                  alt=""
          ...
          <Link to={`/careers/${param.id}/apply`}>
            <button className="dark:bg-slate-800 dark:text-white dark:border-white  bg-blue-500 hover:bg-blue-400 text-white font-bold rounded-full mb-[50px] mt-[30px] py-[5px] px-[54px]">
              Apply
            </button>
          </Link>
        </main>
