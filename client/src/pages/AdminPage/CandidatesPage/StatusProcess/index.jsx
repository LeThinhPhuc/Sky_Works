...
const StatusProcess = (props) => {
  ...
  return (
    <div class="relative mx-5">
      ...
      >
        <table className="dark:bg-slate-800 dark:text-white dark:border-white  w-full  text-sm text-center text-gray-500 dark:text-gray-400">
          <thead className="dark:bg-slate-800 dark:text-white dark:border-white  text-xs text-gray-900  bg-gray-300 border-b-[1.5px] dark:bg-gray-700 dark:text-gray-400">
            <tr>
              <th
                scope="col"
                className="dark:bg-slate-800 dark:text-white dark:border-white  px-3 py-3 text-sm font-semibold"
              >
                  ...
                  <div
                    class={`relative z-10 flex items-center justify-center w-6 h-6 ${
                      item.idProcess > stepStatus.length - 1
                        ? "bg-blue-50"
                        : " bg-blue-200"
                    } rounded-full ring-0 ring-white dark:bg-slate-800 sm:ring-8 dark:ring-gray-900 shrink-0`}
                  >
        ...
        <div className="dark:bg-slate-800 dark:text-white dark:border-white  flex   justify-end absolute bottom-[1px] right-1">
          <button
