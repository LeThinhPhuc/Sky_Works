...
const CandidatesDetail = () => {
  ...
  return (
    <div className="dark:bg-slate-700 dark:text-white dark:border-white   ">
      ...
      <div className="dark:bg-slate-700 dark:text-white dark:border-white   mb-10">
        <div className="dark:bg-slate-700 dark:text-white dark:border-white  flex justify-between items-center text-sm border-b py-3 mx-10">
          <div className="dark:bg-slate-700 dark:text-white dark:border-white  flex items-center ">
            <FontAwesomeIcon
              ...
              icon={faArrowLeft}
              className="dark:bg-slate-700 dark:text-white dark:border-white  p-2 fa-xl"
            />
            <div
        ...
        <div className="dark:bg-slate-700 dark:text-white dark:border-white   text-xs flex justify-around ">
          <div className="dark:bg-slate-700 dark:text-white dark:border-white   w-[45%]">
            <div className="dark:bg-slate-700 dark:text-white dark:border-white   text-base font-medium text-gray-400 pb-4 pt-2 ">
              EMPLOYEE DETAILS
            </div>
            <div className="dark:bg-slate-700 dark:text-white dark:border-white  pl-3 pr-3 pt-2 pb-2 bg-slate-100  rounded-[10px] mb-4 ">
            ...
            <div className="dark:bg-slate-700 dark:text-white dark:border-white  relative  pr-3 pt-2 pb-2 bg-slate-100  rounded-[10px] mb-4 ">
            ...
            <div className="dark:bg-slate-700 dark:text-white dark:border-white  flex gap-3 mt-10">
              <button
          ...
          <div className="dark:bg-slate-700 dark:text-white dark:border-white   w-[45%]">
            ...
            <div className="dark:bg-slate-700 dark:text-white dark:border-white  flex text-base font-medium text-gray-400 pb-4 pt-2 ">
              SALARY
            </div>
            <div className="dark:bg-slate-700 dark:text-white dark:border-white  flex">
              <select
                value={select2}
