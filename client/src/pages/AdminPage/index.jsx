...
const AdminPage = () => {
  return (
    <main className="dark:bg-slate-700 dark:text-white dark:border-white  flex  justify-center w-[100%]">
      <Sidebar class="w=[25%]" />
      <div className="dark:bg-slate-700 dark:text-white dark:border-white  flex  flex-col w-[100%]">
        <SearchAndInforAdmin />
        <Outlet />
