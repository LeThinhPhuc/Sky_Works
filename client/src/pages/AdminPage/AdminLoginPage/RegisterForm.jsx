...
const RegisterForm = () => {
  ...
  return (
    <form
      className="dark:bg-slate-800 dark:text-white dark:border-white  flex flex-col px-5 gap-5 w-11/12 place-items-center"
    ...
    >
      ...
      <div className="dark:bg-slate-800 dark:text-white dark:border-white  flex justify-start place-items-center px-5 w-11/12 h-10 bg-[#f0f0f0] rounded-full">
        ...
        <input
          ...
          className="dark:bg-slate-800 dark:text-white dark:border-white  w-full bg-transparent border-none ml-3"
          required
        />
      </div>
      <div className="dark:bg-slate-800 dark:text-white dark:border-white  flex justify-start place-items-center px-5 w-11/12 h-10 bg-[#f0f0f0] rounded-full">
        ...
        <input
          ...
          className="dark:bg-slate-800 dark:text-white dark:border-white  w-full bg-transparent border-none"
          required
        />
      </div>
      <div className="dark:bg-slate-800 dark:text-white dark:border-white  flex justify-start place-items-center px-5 w-11/12 h-10 bg-[#f0f0f0] rounded-full">
